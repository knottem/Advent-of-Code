...
class Day04(text : String = "input.txt") {
    ...
    private val input = File("src/main/resources/$year/$day/$text").readText().take(6).toInt()
    private val input2 = File("src/main/resources/$year/$day/$text").readText().takeLast(6).toInt()
